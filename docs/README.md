...
> 운영 정보(기관명·대표·연락처·보호책임자·시행일)는 기입 완료. **남은 값은 `privacy.html`의 위탁 수탁사(서버 호스팅 주체) 1건** + IRB 승인번호(연구용).
> 건강 앱이므로 배포 전 소속 기관 **IRB 및 개인정보 담당 부서의 최종 검토** 권장.
...
| 개인정보/약관/삭제 문서 | ✅ 값 기입 | 수탁사 1건 + IRB 검토만 남음 |
